  ...
  app.get("/api/publications", async (req, res) => {
    try {
        ...
        },
      {
        ...
        type: "research",
        authors: ["Samruddhi Service Society", "Educational Research Consultants"],
        ...
        tags: ["girls education", "impact assessment", "rural empowerment", "longitudinal study"]
      },
      {
        id: 3,
        title: "Community-Based Rehabilitation: Best Practices from Rural Maharashtra",
        type: "research",
        authors: ["Dr. Priya Sharma", "Community Health Team", "Rehabilitation Specialists"],
        abstract: "This study documents innovative community-based rehabilitation (CBR) approaches developed through our healthcare programs. Covering 15 villages and 500+ beneficiaries, the research highlights cost-effective interventions, community participation strategies, and sustainable health outcomes.",
        ...
        tags: ["community health", "rehabilitation", "rural healthcare", "best practices"]
      },
      ...
      // Case Studies
      {
        ...
        type: "case-study",
        authors: ["Samruddhi Documentation Team"],
        ...
        tags: ["success story", "karate program", "leadership development", "case study"]
      },
      {
        id: 5,
        title: "Transforming Lives: IDC Special Education Success Stories",
        type: "case-study",
        authors: ["Special Education Team", "Child Development Specialists"],
        abstract: "Collection of 10 detailed case studies showcasing successful outcomes from our Integrated Development Center. Features children with various disabilities who achieved remarkable progress through individualized education plans, therapy interventions, and family support programs.",
        publishedDate: "2023-12-15",
        journal: "Special Education Success Stories",
        fileUrl: "https://example.com/downloads/idc-success-stories.pdf",
        tags: ["special education", "success stories", "disability support", "case studies"]
      },
      {
        id: 6,
        title: "Women Entrepreneurs: Microfinance Program Impact Case Studies",
        type: "case-study",
        authors: ["Women Empowerment Team", "Microfinance Specialists"],
        abstract: "In-depth analysis of 15 women who transformed their lives through our microfinance and skill development programs. Documents their journey from traditional roles to successful entrepreneurs, with detailed financial analysis showing 300% average income increase.",
        publishedDate: "2024-01-25",
        journal: "Rural Entrepreneurship Studies",
        fileUrl: "https://example.com/downloads/women-entrepreneurs-case-studies.pdf",
        tags: ["women empowerment", "microfinance", "entrepreneurship", "case studies"]
      },
      ...
      // Reports
      {
        ...
        type: "report",
        authors: ["Samruddhi Service Society Board"],
        abstract: "Comprehensive annual report detailing our achievements across all programs in 2023-24. Highlights include: 501 children supported, 65 girls in residential program, 45 special needs children in IDC, ₹12 lakh fundraising milestone, and expansion to 5 new villages.",
        publishedDate: "2024-04-01",
        journal: "Samruddhi Annual Publications",
        fileUrl: "https://example.com/downloads/annual-report-2023-24.pdf",
        tags: ["annual report", "impact report", "organizational achievements", "transparency"]
      },
      {
        id: 8,
        title: "Financial Transparency Report: Donor Fund Utilization 2023-24",
        type: "report",
        authors: ["Finance Committee", "External Auditors"],
        abstract: "Detailed financial report providing complete transparency on donor fund utilization. Breaks down expenses by program (70% direct program costs, 20% infrastructure, 10% administration), shows cost per beneficiary (₹8,500 annually), and demonstrates measurable outcomes for every rupee donated.",
        publishedDate: "2024-03-20",
        journal: "Financial Accountability Reports",
        fileUrl: "https://example.com/downloads/financial-transparency-2023-24.pdf",
        tags: ["financial transparency", "donor accountability", "audit report", "fund utilization"]
      },
      ...
      // Implementation Guides
      {
        ...
        tags: ["implementation guide", "girls education", "program development", "best practices"]
      },
      {
        id: 10,
        title: "Community Engagement Toolkit: Building Sustainable Rural Programs",
        type: "guide",
        authors: ["Community Relations Team", "Social Work Specialists"],
        abstract: "Practical toolkit for NGOs working in rural communities. Provides frameworks for building trust, engaging local leaders, overcoming cultural barriers, and ensuring community ownership of development programs. Includes 50+ tested strategies, communication templates, and conflict resolution approaches.",
        publishedDate: "2024-02-10",
        journal: "Community Development Resources",
        fileUrl: "https://example.com/downloads/community-engagement-toolkit.pdf",
        tags: ["community engagement", "rural development", "toolkit", "social work"]
      },
      {
        id: 11,
        title: "Fundraising Strategies for Small NGOs: Lessons from the Field",
        type: "guide",
        authors: ["Fundraising Committee", "Development Consultants"],
        abstract: "Comprehensive guide sharing successful fundraising strategies for small and medium NGOs. Covers donor identification, proposal writing, event planning, digital fundraising, corporate partnerships, and donor retention. Based on our journey from ₹50,000 annual budget in 1995 to ₹1.2 crore current operations.",
        publishedDate: "2023-10-15",
        journal: "NGO Management Resources",
        fileUrl: "https://example.com/downloads/fundraising-strategies-guide.pdf",
        tags: ["fundraising", "NGO management", "donor development", "resource mobilization"]
      },
      ...
      // Policy Papers
      {
        ...
        type: "report",
        authors: ["Policy Research Team", "Special Education Experts"],
        ...
        tags: ["policy recommendations", "special education", "government advocacy", "rural education"]
      },
      ...
      // Training Materials
      {
        ...
        type: "guide",
        authors: ["Teacher Training Department", "Special Education Consultants"],
        abstract: "Comprehensive training manual for teachers working with diverse learners including special needs children. Covers classroom adaptation techniques, individualized education planning, behavior management, assessment methods, and parent communication. Developed through training 200+ teachers.",
        ...
        tags: ["teacher training", "inclusive education", "classroom techniques", "special needs"]
      },
      {
        id: 14,
        title: "Parent Engagement Handbook: Supporting Your Child's Development",
        type: "guide",
        authors: ["Family Support Team", "Child Development Specialists"],
        abstract: "Practical handbook for parents of children in our programs, covering child development stages, home learning activities, communication with schools, health and nutrition guidance, and preparing for transitions. Available in Hindi and Marathi, with simple language and visual aids.",
        publishedDate: "2024-03-01",
        journal: "Family Support Resources",
        fileUrl: "https://example.com/downloads/parent-engagement-handbook.pdf",
        tags: ["parent engagement", "child development", "family support", "educational resources"]
      },
      ...
      // Research Collaborations
      {
        ...
        type: "research",
        authors: ["Dr. Anjali Verma (Lead Researcher)", "Samruddhi Service Society", "Tata Institute of Social Sciences", "5 Partner NGOs"],
        abstract: "Large-scale collaborative research study examining the replication and scaling of inclusive education models across 6 states in India. Samruddhi's IDC program serves as one of the primary case studies. The research involves 1000+ children, 50+ schools, and 15+ organizations.",
        ...
        tags: ["collaborative research", "scaling models", "inclusive education", "multi-site study"]
      }
    ];
